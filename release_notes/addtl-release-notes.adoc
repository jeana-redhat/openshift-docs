...
+
xref:../cli_reference/cli_manager/cli-manager-release-notes.adoc#cli-manager-release-notes[{cli-manager}]
+
...
+
xref:../virt/release_notes/virt-4-22-release-notes.adoc#virt-4-22-release-notes[Red Hat {VirtProductName}]
+
