...
[role="_abstract"]
You can install {product-title} on {AWS} or {{gcp-short}} using a cloud account that you own or using a cloud account that is owned by Red Hat. This document provides details about the cloud deployment options for {product-title} clusters.
