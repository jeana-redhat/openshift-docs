...
You can install {product-title} in your own {{gcp-short}} account by using the CCS model. Complete the steps in one of the following sections to deploy {product-title} in your own {gcp-short} account.
