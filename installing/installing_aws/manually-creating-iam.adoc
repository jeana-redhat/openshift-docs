...
To learn how to remove the administrator-level credential secret after installing {product-title}, see xref:../../post_installation_configuration/cluster-tasks.adoc#manually-rotating-cloud-creds_post-install-cluster-tasks[Rotating cloud provider credentials manually].
