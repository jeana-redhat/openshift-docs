...
--
+
For more information about CCO modes, see _About the Cloud Credential Operator_ in the _Managing cloud provider credentials_ section of the _Authentication and authorization_ content.
+
[NOTE]
====
