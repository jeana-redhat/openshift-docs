...
* Google Cloud Provider ({gcp-short})
...
** *Replication repository name*: Specify the replication repository name in the {mtc-short} web console.
** *{gcp-short} bucket name*: Specify the name of the {gcp-short} bucket.
** *{gcp-short} credential JSON blob*: Specify the string in the `credentials-velero` file.
