...
Red Hat recommends deploying your cluster with the On-Demand subscription type purchased through the {{gcp-short}} Marketplace. This option provides flexible, consumption-based billing, consuming additional capacity is frictionless, and no Red Hat intervention is required.
