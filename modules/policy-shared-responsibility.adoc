...
* Monitor the Red Hat Management project in {{gcp-short}} and the Private Service Connect (PSC) attachments. ^[1]^
...
|===
1. Applies to {product-title} on {{gcp-short}} clusters with PSC only.
