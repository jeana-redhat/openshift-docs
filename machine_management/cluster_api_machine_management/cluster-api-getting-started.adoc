...
* xref:../../machine_management/cluster_api_machine_management/cluster_api_provider_configurations/cluster-api-config-options-vmw.adoc#capi-yaml-infrastructure-vmw_cluster-api-config-options-vmw[Sample YAML for a Cluster API infrastructure resource on {vmw-full}]
...
* xref:../../machine_management/cluster_api_machine_management/cluster_api_provider_configurations/cluster-api-config-options-vmw.adoc#capi-yaml-machine-template-vmw_cluster-api-config-options-vmw[Sample YAML for a Cluster API machine template resource on {vmw-full}]
...
* xref:../../machine_management/cluster_api_machine_management/cluster_api_provider_configurations/cluster-api-config-options-vmw.adoc#capi-yaml-machine-set-vmw_cluster-api-config-options-vmw[Sample YAML for a Cluster API compute machine set resource on {vmw-full}]