...
[role="_abstract"]
You can change the configuration of your {aws-first} control plane machines by updating values in the control plane machine set.
...
* xref:../../../machine_management/control_plane_machine_management/cpmso_provider_configurations/cpmso-supported-features-aws.adoc#cpmso-supported-features-aws[Enabling {aws-full} features for control plane machines]